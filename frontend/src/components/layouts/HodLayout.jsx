    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside className="w-60 bg-white border-r border-gray-200 flex flex-col shrink-0 shadow-sm">
        ...
        {(cycle?.interviewDate || cycle?.teachingInteractionDate) && (
          <div className="mx-4 mt-2 rounded-lg border border-indigo-100 bg-indigo-50 px-3 py-2 space-y-1">
            {cycle.teachingInteractionDate && (
              <div>
                <p className="text-xs text-indigo-400 font-medium uppercase tracking-wide">Teaching</p>
            ...
            {cycle.interviewDate && (
              <div>
                <p className="text-xs text-green-500 font-medium uppercase tracking-wide">Interview</p>
